...
import RestrictedContent from "../components/RestrictedContent"; // <--- 1. IMPORT THIS
...
export default function BalancePage() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-8 animate-fade-in pb-20 font-sans text-slate-800">
      ...
      {/* 2. SECURE CONTENT (Cards, Ledger, Modals) */}
      {/* WRAPPED IN RESTRICTED CONTENT: Blurred and Locked if not verified */}
      <RestrictedContent>
