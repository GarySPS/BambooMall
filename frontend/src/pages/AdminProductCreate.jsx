  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        gallery: images, 
        size: sizeJson,
        color: colorJson, // [NEW] Send the processed colors
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 space-y-4">
             ...
             <div className="grid grid-cols-2 gap-4">
               ...
               <div>
                  ...
                  <input type="number" name="min_order" value={formData.min_order} onChange={handleChange} className="w-full p-2 border rounded-md font-mono" />
               </div>
             </div>
