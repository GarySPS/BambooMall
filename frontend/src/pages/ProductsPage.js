...
export default function ProductsPage() {
  ...
  return (
    <div className="space-y-8 animate-fade-in pb-12 max-w-[1600px] mx-auto">
      ...
      {/* ONBOARDING GRANT PROMO CARD (Adapts to KYC Status) */}
      <div className="bg-slate-900 rounded-xl border border-slate-800 shadow-lg overflow-hidden flex flex-col md:flex-row relative">
        ...
        <div className="p-6 md:p-8 flex-1 z-10">
          ...
          <p className="text-slate-400 text-sm md:text-base max-w-2xl leading-relaxed">
            {user?.kyc_status === 'approved' 
              ? "Your dealership identity is verified. You now have full clearance to view wholesale pricing, live inventory, and secure active allocations." 
              : user?.kyc_status === 'pending'
              ? "Your documentation has been received and is under priority review. Live manifest access will unlock upon final compliance approval."
